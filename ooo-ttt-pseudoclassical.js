...
Square.prototype.toString = function() { //what is the use of this method?
  return this.marker;
};
...
function Human() {
  ...
  // Object.setPrototypeOf(this, Player); doesn't work, below is peeking into solution
}

// after peeking into solution, why is below wrong. Why does the above have no new keyword
// let human = new Player();
// human.square = Square.HUMAN_MARKER;
